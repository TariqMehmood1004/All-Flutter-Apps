...
LoadedAccount convertLegacyAccount({
  ...
  {
    String _exception =
        'Account version is higher than the supported account version. Please make sure that you are using the latest release of  before loading this account. Account version: ${_accountVersion.join('.')}, Supported account version: $accountVersion';
...
LoadedAccount convertPre0_3_0Account({
  ...
  _account = LoadedAccount(
    ...
    passwordIcons: Images('$path${Platform.pathSeparator}password_icons',
        encrypter: encrypter),
