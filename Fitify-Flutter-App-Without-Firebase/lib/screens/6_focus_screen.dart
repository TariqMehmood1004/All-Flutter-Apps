...
import 'package:fitifyapp/screens/7_suffer_from_knee_pain_screen.dart';
          ...
          children: [
            ...
            myButton(context, () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => SufferScreen()));
            }, title: "Continue", foreColor: AppColors.black.withOpacity(0.5)),
          ],
        ),
      ),
    );
