...
import 'package:fitifyapp/screens/9_analyzing_your_plan.dart';
...
class CustomTargetWeightRadioButton extends StatefulWidget {
  ...
  @override
  _CustomTargetWeightRadioButtonState createState() =>
      _CustomTargetWeightRadioButtonState();
}

class _CustomTargetWeightRadioButtonState
    extends State<CustomTargetWeightRadioButton>
          ...
          children: [
            ...
            myButton(context, () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const AnalyzingYourResultScreen(),
                ),
              );
