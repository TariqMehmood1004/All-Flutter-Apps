              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        FirebaseFirestore.instance.collection("fypProjects").doc(docId).update(
                            {
        ...
        children: [
          ...
          Container(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('fypProjects').snapshots(),
              builder: (context, snapshot) {
                ...
                if (snapshot.data == null || snapshot.data!.docs.isEmpty) {
                  return const Center(
                    child: Text('No FYP projects found.'),
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String fypTitle = document['FYP_Title'];
                    String description = document['Description'];
                    String members = document['Members'];
                    String supervisor = document['Supervisor'];
