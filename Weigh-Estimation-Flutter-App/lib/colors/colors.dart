...
class AppColors {
  ...
  static Color backgroundDarkTransparent = const Color(0xB8000000);
  ...
  static Color primary = const Color(0xFF2a2a2a);
  static Color secondary = const Color(0xFF3d3d3d);

  static Color buttonColor = const Color(0xFFDAFFFB);
  static Color buttonColor2 = const Color(0xFF001C30);
  static Color offGreen = const Color(0xFF3AA6B9);
  static Color lightWhite = const Color(0xFFF5F5F5);


  static Color blueAccent = const Color(0xFF525FE1);

  static Color color1 = const Color(0xFFFCE9F1);
  static Color color2 = const Color(0xFFB9F3E4);
  static Color bottomNavBGColor = const Color(0xFFE0E0E0);

  static Color snackBarBGColor1 = const Color(0xFFC4DFDF);
  static Color snackBarBGColor2 = const Color(0xFFE5F9DB);

  static Color snackBarBGColor3 = const Color(0xff20262E);
  static Color light = const Color(0xffF6F6F6);


  static Color yellowRGBA = const Color.fromARGB(255, 255, 255, 120);
