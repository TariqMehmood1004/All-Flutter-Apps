        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  MyTextFields(nameController: nameController, hintText: '0', textInputType: TextInputType.number,),
                  SizedBox(height: 50,),
                  myButton(context, title: "Continue",
                      backgroundColor: Colors.orangeAccent, (){
                        Navigator.push(context,
                        MaterialPageRoute(builder: (_) => DailyWalkScreen())
                        );
                      }),
                ],
              ),
